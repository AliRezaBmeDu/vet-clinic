...
**Vet Clinic** is an SQL database created by postgresql. In the database, there are multiple tables linked together to carry out the details of pet animals.
...
https://github.com/AliRezaBmeDu/vet-clinic.git
...
Feel free to check the [issues page](https://github.com/AliRezaBmeDu/vet-clinic/issues).
